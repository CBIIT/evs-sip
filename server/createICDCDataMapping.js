...
const build_ctdc = (dict) => {
    ...
    let ctdc_mapping = readICDCMapping();
...
const readExcelFile = async () => {
    ...
    let file_path = path.join(
        ...
        "data_files",
        "ICDC",
        "ICDC_Data_Model_Terminology.xlsx"
      );
...
const createICDCDataMapping = async () => {
    const ctdcdata = readICDCyamlFilesNew();
